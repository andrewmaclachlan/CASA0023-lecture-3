...
$B_k$ is the additive term, depicting the atmospheric path radiance component (scattering) across different paths of reflectance...see next slide
...
orthorectification = removing distortions... making the pixels viewed at nadir (straight)
...
$BV_i,j,r= \frac{BV_i,j,k}{BV_i,j,l}$

Where $BV_i,j,r$ is the ratio and $BV_i,j,k$ and $BV_i,j,l$ are the values in two other bands
...
* Texture = spatial variation of gray values 
  ...
  * Assign to central pixel in kernel
...
* Usually this is **just the visible bands**, although the Gram-Schmidt algorithm also computes NIR
...
<iframe width="560" height="315" src="https://www.youtube.com/embed/a4dW5EWbNK4" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
...
* Imagery can be "improved" based on the energy reflected and the contrast between features 
* But...
