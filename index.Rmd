...
```
.small[Push Broom and Whisk Broom Sensors. Source:[L3Harris](https://www.l3harrisgeospatial.com/Support/Self-Help-Tools/Help-Articles/Help-Articles-Detail/ArtMID/10220/ArticleID/16262/Push-Broom-and-Whisk-Broom-Sensors#:~:text=Whisk%20broom%20scanners%2C%20also%20sometimes,1).)
]
]
...
Where $x$ and $y$ are positions in the rectified (gold standard) map 

**But** the issue with this is that we are modelling the rectified $x$ and $y$ which could fall anywhere on the gold standard map (e.g. not on a grid square or at a floating point)
...
.small[Radiance vs. Reflectance. Source:[l3harrisgeospatial](https://www.l3harrisgeospatial.com/Support/Self-Help-Tools/Help-Articles/Help-Articles-Detail/ArtMID/10220/ArticleID/19247/3377)]
