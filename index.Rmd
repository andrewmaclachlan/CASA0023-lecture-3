...
`r fa("file-pdf", fill = "#562457")` [PDF presentation](https://github.com/andrewmaclachlan/CASA0023-lecture-3/blob/main/index.pdf)
...
- [Fastcups](https://cups.fast.ai/CASA0023)
...
```{r echo=FALSE, out.width='100%', fig.align='center'}
knitr::include_graphics('img/MSS.png')
```
...
```{r echo=FALSE, out.width='100%', fig.align='center'}
knitr::include_graphics('img/RBV.png')
```
...
knitr::include_graphics('img/whisk_broom.jpg')
```
...
```{r echo=FALSE, out.width='95%', fig.align='center'}
knitr::include_graphics('img/push_broom.jpg')
```
.small[Push Broom and Whisk Broom Sensors. Source:[NV5](https://www.nv5geospatialsoftware.com/Learn/Blogs/Blog-Details/ArtMID/10198/ArticleID/16262/Push-Broom-and-Whisk-Broom-Sensors).)
]
]
...
knitr::include_graphics('img/IMG_5259.jpg')
```
...
**Jensen page [244-247](https://read.kortext.com/reader/pdf/1872407/247) describes:**
...
* Psuedo-invariant Features (PIFs)  
  ...
  * Here y is the value of our base. To get an equivalent to y (base) we multiply our new date pixel (x) by the coefficient and add the intercept value.
...
```{r echo=FALSE, out.width='75%', fig.align='center'}
knitr::include_graphics('img/FglyveuXoAInuBS.jfif')
```
...
* Measured in Watts (power of light here), per metre squared (surface within FOV) per steradian (angle of the view) per nanometre (wavelength) = $W m^2 sr^-1 μm^1$
...
.panel[.panel-name[Reflectance 2]
...
* LaSRC (Landsat 8-9) Collection 2, level 2 product: https://www.usgs.gov/landsat-missions/landsat-collection-2-surface-reflectance

---

class: center, middle

# What is a Collection 2, level 2 product

## Collection - means something has changed or advanced ...

## Level - refers to the data (1- DN, 2 surface reflectance, 3 science products (e.g burn area))
...
* Edge enhancement
  ...
  * The values within the window are summed (weighted sum based on coefficients)
